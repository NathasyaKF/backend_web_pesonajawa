...
<html lang="en">
    ...
    if(isset($_POST['edit']))
    {
		...
		mysqli_query($connection, "update travel set travelNAMA = '$travelNAMA',
			travelALAMAT = '$travelALAMAT'
            where travelKODE = '$travelKODE'");
		echo "<script>alert('DATA BERHASIL DIEDIT');
        document.location='travel.php'</script>";
    }

    //untuk menerima data dari file travel yang akan diedit 
...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="travelKODE" id="travelKODE" value="<?php echo $rowedit["travelKODE"]?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="travelNAMA" id="travelNAMA" value="<?php echo $rowedit["travelNAMA"]?>">
    </div>
  </div>  
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="travelALAMAT" id="travelALAMAT" value="<?php echo $rowedit["travelALAMAT"]?>">
    </div>
  </div>  
