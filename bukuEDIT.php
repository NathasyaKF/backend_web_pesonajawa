...
if(isset($_POST["edit"]))
{
    ...
    mysqli_query($connection, "update buku set bukuKODE = '$bukuKODE',
			bukuJUDUL = '$bukuJUDUL'
            where bukuKODE = '$bukuKODE'");
		echo "<script>alert('DATA BERHASIL DIEDIT');
        document.location='buku.php'</script>";
    }

    //untuk menerima data dari file buku yang akan diedit 
    $bukuKODE = $_GET["ubah"];
    $editbuku = mysqli_query($connection,"select * from buku
        where bukuKODE = '$bukuKODE'");
    $rowedit = mysqli_fetch_array($editbuku);
...
<form method="POST">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name= "kodebuku" id="kodebuku" value="<?php echo $rowedit["bukuKODE"]?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name= "namabuku" id="namabuku" value="<?php echo $rowedit["bukuJUDUL"]?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name= "hargabuku" id="hargabuku" value="<?php echo $rowedit["bukuHARGA"]?>">
    </div>
  </div>
