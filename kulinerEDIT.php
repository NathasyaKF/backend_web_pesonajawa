...
// Menerima data dari file kuliner yang akan diedit 
$kulinerKODE = $_GET["ubah"];
$editkuliner = mysqli_query($connection, "select * from kuliner where kulinerKODE = '$kulinerKODE'");
...
if (isset($_POST['edit'])) {
    ...
    if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) {
        ...
        mysqli_query($connection, "UPDATE kuliner SET kulinerNAMA='$kulinerNAMA', kulinerALAMAT='$kulinerALAMAT', kulinerFILE='$namafile' WHERE kulinerKODE='$kulinerKODE'");
		echo "<script>alert('DATA BERHASIL DIEDIT'); document.location='kuliner.php'</script>";
    }
}
?>
...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kulinerKODE" id="kulinerKODE" value="<?php echo $rowedit["kulinerKODE"]?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kulinerNAMA" id="kulinerNAMA" value="<?php echo $rowedit["kulinerNAMA"]?>">
    </div>
  </div>  
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kulinerALAMAT" id="kulinerALAMAT" value="<?php echo $rowedit["kulinerALAMAT"]?>">
    </div>
  </div>  
