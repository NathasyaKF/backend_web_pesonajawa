        ...
        <div id="layoutSidenav">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <?php
							...
							if(isset($_POST['edit'])) { //isset yang di kirim ada isinya atau tidak
								...
								if ($_FILES['file']['size'] > 0) {
									...
									if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
									{
										...
										mysqli_query($connection, "UPDATE destinasi set destinasiNAMA = '$destinasiNAMA',
											kategoriKODE = '$kategoriKODE', destinasiKET = '$destinasiKET', destinasiFILE = '$destinasiFILE'
								...
								echo "<script>alert('DATA BERHASIL DIEDIT'); document.location='d-destinasi.php'</script>";
			...
			<form method="POST" enctype="multipart/form-data">
			  ...
			  <div class="mb-3 row">
				...
				<div class="col-sm-10">
				  <input type="text" class="form-control" name= "kodedestinasi" id="kodedestinasi" value="<?php echo $rowedit["destinasiKODE"]?>">
				</div>
			  </div>
			...
			?>
			  ...
			  <div class="mb-3 row">
                ...
                <div style="margin-top: 10px;" class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <td>
								<?php if (!empty($row['destinasiFILE']) && is_file("images/".$row['destinasiFILE'])): ?>
									<img src="images/<?php echo $row['destinasiFILE']?>" width="80" alt="Current Image">
								<?php endif; ?>
							</td>
				  ...
				  <div class="form-group row">
					...
					function batalRedirect() {
						window.location.href = 'd-destinasi.php';
					}
					</script>
